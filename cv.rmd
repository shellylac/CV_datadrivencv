...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at https://github.com/shellylac/CV_datadrivencv/ShellyL_cv.pdf")
} else {
...
Data and Language Skills {#skills}
--------------------------------------------------------------------------------
